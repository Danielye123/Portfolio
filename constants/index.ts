...
export const projectData = [
  {
    ...
    challenges: {
      challenges: [
        ...
        {
          text3: "Introduction to many different technologies and features such as Alan AI, React, Material UI, Redux Toolkit",
          icon: challenge,
        },
      ],
      learnings: [
  ...
  },
  {
    ...
    challenges: {
      challenges: [
        {
          text1: "Gained extensive knowledge on frontend and backend and connecting them together.",
          icon: challenge,
        },
        {
...
export const caseStudies = [
  ...
  },
  {
    id: "hipnode",
    name: "Hipnode",
    description: "Hipnode, a social media application made with React and Next.js",
    image: hipnodeLink,
    link: "/hipnode",
  },
  {
