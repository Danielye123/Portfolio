...
const FilmpireDescription = () => {
  return (
    <div className="w-full px-[280px] py-[72px] bg-[#F3F8FF] dark:bg-[#192333] text-[#6F74A7] dark:text-[#F3F8FF] font-poppins font-normal text-[20px] leading-[30px]">
      ...
      My team and I also developed the car
