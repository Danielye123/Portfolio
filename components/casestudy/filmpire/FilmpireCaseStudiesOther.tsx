  ...
  return (
    ...
    <div className="container 2xl:px-[280px] md:px-[72px] px-[24px] py-[72px]">
      ...
      <div className="lg:w-[430px] lg:h-[460px] w-[345px] h-[385px] bg-[#FFFFFF] dark:bg-[#192333] rounded-[20px] flex flex-col shadow-md shadow-[#E0ECFF] dark:shadow-xl dark:shadow-[#1F2C41]">
          ...
          <Link
            href="/morrent"
            className="lg:w-96 lg:h-[48px] w-[307px] h-[41px] mx-[24px] py-[14px] lg:px-[135px] rounded-full border border-[#0252CD] gap-[10px] bg-[#0252CD] hover:bg-[#428DFF] dark:bg-[#428DFF] dark:hover:bg-[#0252CD] text-white flex justify-center items-center"
          >
