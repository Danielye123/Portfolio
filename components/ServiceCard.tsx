...
const ServiceCard = () => {
  return (
    <div className="flex flex-row flex-wrap gap-[40px] mt-8 md:mt-16 justify-center">
    ...
    hover:scale-105 hover:mt-4 hover:bg-[#0252CD] dark:hover:bg-[#428DFF] hover:text-[#F3F8FF] hover:shadow-lg custom-box-shadow dark:hover:shadow-lg serviceCard`}
        >
          <div
